  ...
  return (
    <>
      ...
      <div style={{
        ...
        {/* Messages Container - Takes all remaining space */}
        <div 
          style={{
            flex: 1,
            overflowY: 'auto',
            overflowX: 'hidden',
            padding: '20px',
            paddingBottom: '90px', // Space for fixed input
      ...
      {/* Input Container - Completely Separate, Fixed to Bottom */}
      <div style={{
        position: 'fixed',
        bottom: 0,
        left: 0,
